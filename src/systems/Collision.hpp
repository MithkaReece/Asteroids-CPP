...
namespace System
{
    ...
    private:
                                     ...
                                     entt::entity entity2, Component::Transform transform2, Component::Velocity velocity2, int level2)
        {
            ...
            if (level1 > 1)
            {
                Entity::createAsteroid(registry, window, level1 - 1, transform1.position + (level1 - 1) * (level1 - 1) * 15.0f * perpNormal, velocity3);
                Entity::createAsteroid(registry, window, level1 - 1, transform1.position - (level1 - 1) * (level1 - 1) * 15.0f * perpNormal, velocity4);
            }

            if (level2 > 1)
            {
                Entity::createAsteroid(registry, window, level2 - 1, transform2.position + (level2 - 1) * (level2 - 1) * 15.0f * perpNormal, velocity5);
                Entity::createAsteroid(registry, window, level2 - 1, transform2.position - (level2 - 1) * (level2 - 1) * 15.0f * perpNormal, velocity6);
            }
        }
